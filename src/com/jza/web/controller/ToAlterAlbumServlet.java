...
public class ToAlterAlbumServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ToAlterAlbumServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Album album = aa.findAlbumByAlbum_id(album_id);
		...
		request.getRequestDispatcher("/AlterAlbum.jsp").forward(request, response);
