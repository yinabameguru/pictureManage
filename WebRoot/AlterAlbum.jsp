...
<%@ page language="java" import="java.util.*" import="com.jza.service.BgService" pageEncoding="UTF-8"%>
<%
						...
						<article class="article container well a-rotateinLT mybody3">
							...
							<div class="centent-article">
								...
								<div class="title-article">
									<h1>新建相册<br><span class="label label-info" style="font-size:13px;"></span></h1> 
									</div><br/><br/>
								
								<div class="alert alert-success">
								<form name="form1" action="/pictureManage/AlterAlbumServlet?Album_id=<%=album.getAlbum_id()%>" method="post" enctype="multipart/form-data">

								    <table align="center" class="tab">
								    
								    <tr>
								    <td>标题：</td>
								    <td class="tdRight"><input type="text" name="albumTitle"  class="tdRight" value="<%=album.getAlbum_title()%>"></td>
								    </tr>
								    <tr>
								    <td>日期：</td>
								    <td class="tdRight"><input type="date" name="albumDate"  class="tdRight" value="<%=album.getAlbum_date()%>"></td>
								    </tr>
								    <tr>
								    <td>封面：</td>
								    <td class="tdRight"><input type="file"  name="albumCover" multiple="multiple" accept="image/*"  class="tdRight" value="<%=album.getAlbum_cover()%>"></td>
								    </tr>
								    <tr> 
								    <td valign="top">描述：</td>
								    <td>
								    <textarea cols="40" rows="4" style="OVERFLOW: visible" name="albumDescription"  class="tdRight2"><%=album.getAlbum_describe()%></textarea>
								    </td>
								    </tr>
								    <tr>
								    <td colspan="2" align="center"><input type="submit" style="background: none; border:none;color:#69A069;font-weight:bold;" value="确定"></td>
								    </tr> 
								    </table>
								   </form> 
								</div>
