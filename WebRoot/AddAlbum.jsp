					...
					<div class="col-md-8">
						...
						<article class="article container well a-rotateinLT mybody3">
							...
							<div class="centent-article">
								...
								<form name="form1" action="/pictureManage/NewAlbumServlet?user_id=<%=user_id %>" method="post" enctype="multipart/form-data">

								    <table align="center" class="tab">
								    
								    <tr>
								    <td>标题：</td>
								    <td class="tdRight"><input type="text" name="albumTitle"  class="tdRight"></td>
								    </tr>
								    <tr>
								    <td>日期：</td>
								    <td class="tdRight"><input type="date" name="albumDate"  class="tdRight"></td>
								    </tr>
								    <tr>
								    <td>封面：</td>
								    <td class="tdRight"><input type="file"  name="albumCover" accept="image/*"  class="tdRight" ></td>
								    </tr>
								    <tr>
								    <td valign="top">描述：</td>
								    <td>
								    <textarea cols="40" rows="4" style="OVERFLOW: visible" name="albumDescription"  class="tdRight2"></textarea>
								    </td>
								    </tr>
								    <tr>
